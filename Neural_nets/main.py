...
class Our_Neural_Network(nn.Module):
    def __init__(self, in_channels, n_classes):
        ...
        self.fc_layers = nn.Linear(256 * 1 * 1, n_classes) #the features of the last pooling are 1*1*512
...
for epoch in range(0, 50):
    ...
    #--- YOUR CODE HERE ---#
    valid_epoch_loss, valid_epoch_acc = validate(net, testloader,  
                                                 criterion)
